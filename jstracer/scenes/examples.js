...
export function AssortedShapes() {
    let finish = new Finish({ ambient: 0.1, diffuse: 0.6, specular: 0.9 });
    ...
    let shapes = [
        ...
        new Box(new Vector(-1, 0, -1), new Vector(1, 2, 1), new Texture(new Color("#90f"), finish)),
        new Sphere(new Vector(3, 1, 0), 1, new Texture(new Color("#0f0"), finish)),
